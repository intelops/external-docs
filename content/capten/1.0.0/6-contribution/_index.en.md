...
│   └── core_group_apps.yaml     # YAML file with the list of core group applications.
│   └── default_group_apps.yaml  # YAML file with the list of default group application.
│
...
9. You can also contribute to `kad` following the guidelines [here](https://github.com/kube-tarian/kad/blob/main/contribution.md).

[ClickHere](https://github.com/kube-tarian/kad) to visit the kad repository
